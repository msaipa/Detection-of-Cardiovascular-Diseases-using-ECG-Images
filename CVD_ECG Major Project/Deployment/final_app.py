...
if uploaded_file is not None:
  ...
  image1=imread('D://MY CREATIONS//MAJOR PROJECT SEM-8//Cardiovascular-Detection-using-ECG-images-main (1)//Cardiovascular-Detection-using-ECG-images-main//ECG_IMAGES_DATASET//ECG Images of Patient that have History of MI (172x12=2064)//PMI(1).jpg')
  image1 = color.rgb2gray(image1)
  image1=resize(image1,(1572,2213))

  image2=imread('D://MY CREATIONS//MAJOR PROJECT SEM-8//Cardiovascular-Detection-using-ECG-images-main (1)//Cardiovascular-Detection-using-ECG-images-main//ECG_IMAGES_DATASET//ECG Images of Patient that have abnormal heartbeat (233x12=2796)//HB(2).jpg')
  image2 = color.rgb2gray(image2)
  image2=resize(image2,(1572,2213))

  image3=imread('D://MY CREATIONS//MAJOR PROJECT SEM-8//Cardiovascular-Detection-using-ECG-images-main (1)//Cardiovascular-Detection-using-ECG-images-main//ECG_IMAGES_DATASET//Normal Person ECG Images (284x12=3408)//Normal(1).jpg')
  image3 = color.rgb2gray(image3)
  image3=resize(image2,(1572,2213))

  image4=imread('D://MY CREATIONS//MAJOR PROJECT SEM-8//Cardiovascular-Detection-using-ECG-images-main (1)//Cardiovascular-Detection-using-ECG-images-main//ECG_IMAGES_DATASET//ECG Images of Myocardial Infarction Patients (240x12=2880)//MI(2).jpg')
  ...
  if similarity_score > 0.70:
    ...
    loaded_model = joblib.load('D://MY CREATIONS//MAJOR PROJECT SEM-8//Cardiovascular-Detection-using-ECG-images-main (1)//Cardiovascular-Detection-using-ECG-images-main//model_pkl//Heart_Disease_Prediction_using_ECG (4).pkl')
